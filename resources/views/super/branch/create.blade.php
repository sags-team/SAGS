                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 offset-md-2">
                                    ...
                                    <input 
                                        ...
                                        name="cnpj" value="{{ old('cpnj') }}" required autocomplete="cnpj"
                                        autofocus>
                                    @if ($errors->has('cnpj'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input 
                                        ...
                                        name="minContribution" value="{{ str_replace( '.',',',number_format(old('minContribution')/100, 2)) }}" required autocomplete="minContribution">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2 offset-md-1">
                                    ...
                                    <select id="ddi1" class="form-control" name="ddi1">
                                        ...
                                        <option  @if (old('ddi1') == $ddi["callingCode"]) selected="selected" @endif
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2 offset-md-1">
                                    ...
                                    <select id="ddi2" class="form-control" name="ddi2">
                                        @foreach($ddiCodes as $ddi)
                                        <option  @if (old('ddi2') == $ddi["callingCode"]) selected="selected" @endif
                                                value={{$ddi["callingCode"]}}>{{$ddi["callingCode"]}} {{$ddi["name"]}}</option>
                                        @endforeach
                                    </select>
                                </div>
